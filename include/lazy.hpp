...
public:
  Lazy() {}
  template <typename Func, typename... Args> Lazy(Func func, Args &&... args) {
  ...
  bool IsValueCreated() const { return value_.IsInit(); }
...
//获取 Lazy<T>对象，T == typename std::result_of<Fn(Args...)>::type,
//构造函数参数为 创建T对象的函数
template <typename Fn, typename... Args>
Lazy<typename std::result_of<Fn(Args...)>::type> lazy(Fn &&fn,
                                                      Args &&... args) {
